    ...
    <header className="sticky top-0 z-10 border-b border-cyan/20 bg-void/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <div className="flex items-center gap-3">
          <span className="h-2 h-2 animate-blink rounded-full bg-signal shadow-glow-signal" />
        ...
        <div className="hidden items-center gap-8 font-mono text-xs uppercase tracking-widest text-static sm:flex">
          ...
          <span>
            <span className={breachCount > 0 ? "text-magenta" : "text-static"}>
              {breachCount}
            </span>{" "}
            breaches
          </span>
        ...
        <div className="flex items-center gap-4">
          <span className="hidden font-mono text-xs text-static md:inline">
            {userEmail}
          </span>
